...
function CardProcuct({ image, name, count, pro, type, ...rest }) {
  const imageTemplate = (
    <MKBox
      bgColor="white"
      borderRadius="xl"
        ...
        <MKBox mt={1} ml={1} lineHeight={1}>
          ...
          {type == 1 && (
            <MKTypography variant="button" fontWeight="regular" color="secondary">
              {
                "Silla Polycar Cannes con cuerpo elaborado en plástico, apta para espacios exteriores medidas de 90 cm. de alto por 50 cm. de ancho."
              }
            </MKTypography>
          )}
          {type == 2 && (
            <MKTypography variant="button" fontWeight="regular" color="secondary">
              {"Mesa plegable 183.8 X 73.6 X 76.2 cm. blanco LIFETIME"}
            </MKTypography>
          )}
          {type == 3 && (
            <MKTypography variant="button" fontWeight="regular" color="secondary">
              {"Mantel color blanco con medidas de :"}
            </MKTypography>
          )}
        </MKBox>
      ) : null}
